...
class ThreeBallAuto
    : public frc2::CommandHelper<frc2::SequentialCommandGroup,
                                 ThreeBallAuto> {
 public:
  ThreeBallAuto(FloorIntake* floorIntake, DriveTrain* driveTrain, Shooter* shooter, BallHolder* ballHolder, Feeder* feeder, Gyro* gyro, Vision* vision, Arm* arm, AutoVaribles* autoVaribles);
};
